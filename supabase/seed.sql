...
insert into public.plant_variants (id, species_id, size_tier, height_min_cm, height_max_cm, photo_path, price_aed, stock_total, published) values
  ('40000000-0000-4000-8000-000000000101', '40000000-0000-4000-8000-000000000001', 'desk', 30, 45, 'seed/snake-desk.jpg', 55.00, 24, true),
  ('40000000-0000-4000-8000-000000000102', '40000000-0000-4000-8000-000000000001', 'floor', 80, 110, 'seed/snake-floor.jpg', 95.00, 10, true),
  ('40000000-0000-4000-8000-000000000103', '40000000-0000-4000-8000-000000000002', 'desk', 30, 45, 'seed/zz-desk.jpg', 60.00, 18, true),
  ('40000000-0000-4000-8000-000000000104', '40000000-0000-4000-8000-000000000002', 'floor', 70, 100, 'seed/zz-floor.jpg', 105.00, 8, true),
  ('40000000-0000-4000-8000-000000000105', '40000000-0000-4000-8000-000000000003', 'desk', 25, 40, 'seed/pothos-desk.jpg', 45.00, 30, true),
  ('40000000-0000-4000-8000-000000000106', '40000000-0000-4000-8000-000000000004', 'desk', 30, 45, 'seed/aglaonema-desk.jpg', 65.00, 14, true),
  ('40000000-0000-4000-8000-000000000107', '40000000-0000-4000-8000-000000000004', 'floor', 70, 95, 'seed/aglaonema-floor.jpg', 100.00, 6, true),
  ('40000000-0000-4000-8000-000000000108', '40000000-0000-4000-8000-000000000005', 'statement', 160, 190, 'seed/kentia-statement.jpg', 175.00, 5, true),
  -- Published but out of stock: must render as unavailable, not disappear (FR-024).
  ('40000000-0000-4000-8000-000000000109', '40000000-0000-4000-8000-000000000006', 'statement', 160, 190, 'seed/areca-statement.jpg', 165.00, 0, true),
