    ...
    <>
      <header className="border-b border-line bg-foreground text-white">
        <nav className="mx-auto flex w-full max-w-4xl items-center gap-5 px-6 py-4 text-sm">
          ...
          <Link href="/ops/depot" className="opacity-80 hover:opacity-100">
            Depot
          </Link>
          <Link href="/ops/requests" className="opacity-80 hover:opacity-100">
            Requests
          </Link>
          <Link href="/ops/visits" className="opacity-80 hover:opacity-100">
            Visits
          </Link>
